...
fetch.addRoute('https://somekindofserver.com/main', {
    get: {
        response: [{
...
async function fetchDatos() {
    const response = await fetch('https://somekindofserver.com/main');
...
function Creartarjetas(datos){
    datos.forEach(element => {
        ...
        const divInsideCard1 = document.createElement('div');
